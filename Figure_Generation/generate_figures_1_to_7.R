...
generate_cumulative_line_plot(
  data = data_file,
  column_of_interesqt = column_of_interest,
  col_order = col_order,
  col_colors = col_colors,
...
combined_data_long_z <- read.csv("gbm_mean_by_stage_table_norm_gly_enz_new.csv")
...
significant_data <- readRDS("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/glycan_cell_significant_data_fig_5.rds")
...
glycan_gene_lists <- readRDS("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/glycan_gene_lists_fig_5.rds")
...
go_results <- readRDS("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/go_results_fig_5.rds")
...
overlap_matrix <- readRDS("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/overlap_matrix_fig_5.rds")
...
filtered_overlap_matrix <- readRDS("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/filtered_overlap_matrix_fig_5.rds")
...
merged_all_top_go_df <- readRDS("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/merged_all_top_go_df_fig_5.rds")
# Load necessary libraries
library(dplyr)
library(ggraph)
library(tidygraph)
...
ggplot(filtered_data_wide, aes_string(x = feature_x, y = feature_y, size = feature_size, color = "who_grade")) +
  ...
  scale_color_manual(
    values = c("2" = "#7e57c2", "3" = "#ffd54f", "4" = "#4fc3f7")  # Assign specific colors
  )+
  labs(
    x = NULL,
    y = NULL,
...
write.csv(
  top_75,
  file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Supplement/top_75.csv",
  row.names = FALSE
)
...
p
# Save the plot as a PNG file
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/CD31_intensity_who_grade_plot.png", plot = p, dpi = 600, height = 43, width = 40, units = "mm")
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/VEGFA_who_grade_plot.png", plot = p, dpi = 600, height = 43, width = 40, units = "mm")
...
write.csv(
  top_75,
  file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Supplement/top_75_survival.csv",
  row.names = FALSE
)
