...
heatmap <- Heatmap(heatmap_data, 
  ...
  png("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Supplement/coverage_heatmap.png", width = 31, height = 85, units = "mm", res = 1200)
  draw(heatmap)
  dev.off()
...
generate_marker_pair_summary_heatmap <- function(data_file, metadata_file, column_names, column_of_interest, col_order = NULL, color_gradient = colorRamp2(c(0, 1, 50), c("white", "white", "#b81b4a"))) {
  ...
  #Export the heatmap to a PNG file with correct dimensions
  png("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/coabundance_heatmap_output_updated.png", width = 30, height = 30, units = "mm", res = 1200)
  draw(heatmap)
  dev.off()
...
generate_coexpression_heatmap <- function(top_combinations_file, tumor_cells_file, metadata_file, column_names, column_of_interest, col_order = NULL, color_gradient = colorRamp2(c(0, 1, 50), c("white", "white", "#b81b4a"))) {
  ...
  print(heatmap)
  # Export the heatmap to a PNG file with correct dimensions
  png("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/heatmap_output_co_expression.png", width = 31, height = 85, units = "mm", res = 1200)
  draw(heatmap)
  dev.off()
}
...
master_feature_table_filtered <- readRDS("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/20240810_master_feature_table_na_removed.rds")
MALDI_data <- read.csv("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/20240702_Stanford_MALDI_annotated.csv")
classes <- read.csv("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/glycan_classes.csv")
tumor_antigen_segment_df <- read_parquet("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/tumor_antigen_segment_df.parquet")
cell_table_all_merged_thresholded <- read_parquet("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/My Drive/Projects/GBM/Cohort_analysis/tables/cell_table_all_merged_thresholded.parquet")
...
webshot("fig2.html", file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_1/final/broad_pie.png", zoom = 10, vwidth = 600, vheight = 600, selector = "div.plot-container")
...
ggsave(
  filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_1/final/Lymphoid_stacked.png",
  plot = plot,
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/heatmap_immune_cells.png", plot = combined_plot, width = 55, height = 90, units = "mm", dpi = 1200)
write_csv(tumor_ab_in_merged_heatmap, "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/tumor_ab_in_merged_heatmap.csv")


# Panel b - Tumor heatmap ----
...
# 
# # Plot the ggplot heatmap with the correct row order
# heatmap_plot <- ggplot(tumor_ab_in_merged_heatmap, aes(x = who_diagnosis, y = feature_variable)) +
#   geom_tile(aes(width = 1, height = 1), color = "black", linewidth = 0.5, fill = NA) +  # Add boxes around each point
#   geom_point(
...
#   theme_minimal() +
#   theme(
#     axis.text.x = element_text(angle = 90, hjust = 1, size = 14),  # Rotate and resize x-axis text
#     #axis.text.x = element_blank(),  # Rotate and resize x-axis text
#     axis.text.y = element_text(size = 14),  # Resize y-axis text
#     axis.ticks.x = element_blank(),  # Remove x-axis ticks
...
#   ) +
#   guides(
#     size = guide_legend(title = "Log10 Average Abundance"),  # Update legend title
#     fill = guide_colourbar(title = "Z-Score Average Abundance")
#   )
# 
# # Combine the dendrogram and heatmap plots with adjusted height
# combined_plot <- grid.arrange(dend_plot, heatmap_plot, ncol = 2, widths = c(0.5, 4))
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/heatmap_tumor_cells.png", plot = combined_plot, width = 55, height = 40, units = "mm", dpi = 1200)
...
# Save the plot as a vector image file
ggsave(
  filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/annotation_plot.png",
...
# Panel d - Shannon diversity index ----
...
p <- ggplot(merged_data, aes(x = final_diagnosis_simple, y = shannon_index)) +
  geom_boxplot(fill = "#85B7CE", color = "black", outlier.shape = NA, size = 0.25) +
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/shannon_diversity_index_plot.pdf", plot = p, height = 33, width = 52, units = "mm")


# Panel e - g tumor ag coverage  -----
data_file <- read_parquet("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/top_seven_df.parquet")
...
generate_cumulative_line_plot(
  ...
  output_filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/no_change_tumor_coverage.pdf",  # Specify your desired file name
...
generate_cumulative_line_plot(
  ...
  col_order = col_order,
  col_colors = col_colors,
  output_filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/change_tumor_coverage.pdf",  # Specify your desired file name
  width = 45,   # Width in millimeters
  height = 35  # Height in millimeters
)
...
plot <- generate_violin_plot(
  ...
  col_order = col_order,
  col_colors = col_colors,
  output_filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_2/final/violin_plot.pdf",  # Specify your desired file name
...
# Panel h - top tumor ag for coverage, % patient heatmap ----
...
# panel i - Python notebook for Venn diagrams 
###### Figure 3 ################################################################

# Panel a - tumor ag dynamic range single cell plot -----
...
# Save the plot as a PNG file
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_3/final/sampled_data_plot.png", plot = plot, 
       dpi = 1200, width = 320, height = 100, units = "mm")



# Panel c - d dyanmic range /mean intensity/coverage bubble plot ----

antigen_intensity <- read_parquet("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/melted_cell_table_marker_intensity_median.parquet")
...
tumor_count_result <- read_parquet("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/tumor_count_result.parquet")
all_cell_count_tumor_FOV_result <- read_parquet("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/all_cell_count_tumor_FOV_result.parquet")
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_3/final/scatter_plot_B7H3_linear.svg", width = 100, height = 50, units = "mm")
...
# Export as SVG with the specified size
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_3/final/scatter_plot_EGFR_linear.svg", width = 100, height = 50, units = "mm")
...
###### Figure 4 ################################################################
# Panel c - DE cells for longitudinal LGG ----
...
# Create the plot with p-values annotated and simplified titles
ggplot(long_data_with_pvals, aes(x = recurrence_status_paired, y = feature_value)) +
  geom_boxplot() + 
  geom_jitter(width = 0.2) +
  facet_wrap(~ feature_variable_clean, scales = "free") +  # Facet by clean feature_variable
  theme_minimal() +
  labs(x = "Recurrence Status", y = "Feature Value", title = NULL) +  # No global title
  geom_text(
    data = long_data_with_pvals %>% 
      distinct(feature_variable_clean, p_value),
    aes(label = paste0("p = ", round(p_value, 3)), x = Inf, y = Inf),
    vjust = 1.5, hjust = 1.1, inherit.aes = FALSE, size = 3, color = "#B81B4A"
  )
...
log2fc_plot <- ggplot(log2fc_data, aes(x = log2FC, y = reorder(feature_variable_clean, log2FC))) +
  ...
  scale_color_manual(
    values = c("significant" = "#B81B4A", "non-significant" = "#00429D")
  )

log2fc_plot
# Save the ggplot as an SVG
ggsave(
  filename <- "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_4/final/log2fc_plot_fig_4.pdf",
  plot = log2fc_plot,  # Use the ggplot object directly
  device = "pdf",
  width = 35 / 25.4,  # Convert mm to inches
  height = 75 / 25.4,  # Convert mm to inches
  units = "in"
)


# Panel f - h functional marker quiche vs bulk heatmaps ----

# File paths
tim3_path <- "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/My Drive/Projects/GBM/Cohort_analysis/tables/TIM3_func_filtered_LGG_primary_recurrence_1.csv"
ido1_path <- "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/My Drive/Projects/GBM/Cohort_analysis/tables/IDO1_func_filtered_LGG_primary_recurrence_1.csv"
cd86_path <- "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/My Drive/Projects/GBM/Cohort_analysis/tables/CD86_func_filtered_LGG_primary_recurrence_1.csv"

# Save directory path
save_dir <- "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_4/final"

# Read the data
tim3_data <- read.csv(tim3_path, row.names = 1)
ido1_data <- read.csv(ido1_path, row.names = 1)
cd86_data <- read.csv(cd86_path, row.names = 1)

# Replace NA values with 100 to mark them visually
tim3_data[is.na(tim3_data)] <- 100
ido1_data[is.na(ido1_data)] <- 100
cd86_data[is.na(cd86_data)] <- 100

# Convert to matrices
tim3_matrix <- as.matrix(tim3_data)
ido1_matrix <- as.matrix(ido1_data)
cd86_matrix <- as.matrix(cd86_data)

# Create temporary matrices with 100 replaced with NA for scaling
tim3_temp <- tim3_matrix
ido1_temp <- ido1_matrix
cd86_temp <- cd86_matrix

tim3_temp[tim3_temp == 100] <- NA
ido1_temp[ido1_temp == 100] <- NA
cd86_temp[cd86_temp == 100] <- NA

# Define color palettes (100 = light gray, ignored in scaling)
col_fun_tim3 <- colorRamp2(
  c(min(tim3_temp, na.rm = TRUE), 0, max(tim3_temp, na.rm = TRUE)),
  c("#00429D", "white", "#B81B4A")
)
col_fun_ido1 <- colorRamp2(
  c(min(ido1_temp, na.rm = TRUE), 0, max(ido1_temp, na.rm = TRUE)),
  c("#00429D", "white", "#B81B4A")
)
col_fun_cd86 <- colorRamp2(
  c(min(cd86_temp, na.rm = TRUE), 0, max(cd86_temp, na.rm = TRUE)),
  c("#00429D", "white", "#B81B4A")
)

# Modify matrices to color 100 as light gray
tim3_matrix[tim3_matrix == 100] <- NA
ido1_matrix[ido1_matrix == 100] <- NA
cd86_matrix[cd86_matrix == 100] <- NA

plot_heatmap <- function(data, title, col_fun) {
  Heatmap(
    data,
    name = title,
    col = col_fun,
    cluster_rows = FALSE,
    cluster_columns = FALSE,
    row_names_gp = gpar(fontsize = 0),  # Completely hide row names
    column_names_gp = gpar(fontsize = 0),  # Completely hide column names
    rect_gp = gpar(col = "black", lwd = 2),  # Grid border color
    na_col = "black",  # Set color for NA values
    border = TRUE,  # Add border around the heatmap
    show_heatmap_legend = FALSE  # Disable legend
  )
}

# Plot heatmaps with individual color palettes
heatmap1 <- plot_heatmap(tim3_matrix, "TIM3", col_fun_tim3)
heatmap2 <- plot_heatmap(ido1_matrix, "IDO1", col_fun_ido1)
heatmap3 <- plot_heatmap(cd86_matrix, "CD86", col_fun_cd86)

# Draw heatmaps with legends and zero padding (no extra margins)
draw(heatmap1, padding = unit(c(1, 1, 1, 1), "cm"))
draw(heatmap2, padding = unit(c(1, 1, 1, 1), "cm"))
draw(heatmap3, padding = unit(c(1, 1, 1, 1), "cm"))

# Save function to generate and save PNGs
save_heatmap_as_png <- function(heatmap, filename) {
  png(filename, width = 200, height = 400, units = "mm", res = 300)
  draw(heatmap, padding = unit(c(1, 1, 1, 1), "cm"))
  dev.off()
}
...
# Save the heatmaps as PNGs
save_heatmap_as_png(heatmap1, file.path(save_dir, "TIM3_heatmap.png"))
save_heatmap_as_png(heatmap2, file.path(save_dir, "IDO1_heatmap.png"))
save_heatmap_as_png(heatmap3, file.path(save_dir, "CD86_heatmap.png"))





# Panel i - volcano plot functional marker + cell type DE ----
...
volcano_plot <- ggplot(aggregated_table, aes(x = log2_fold_change, y = -log10(p_value))) +
  geom_point(aes(
    color = significance,
    stroke = 0,
    alpha = ifelse(significance == "Not Significant", 0.3, 1)
  ...
  scale_color_manual(
    values = c("Significant" = "#B81B4A", "Not Significant" = "#00429D"),
    guide = "none"
  ) +
...
ggsave(
  filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_4/final/log2fc_plot_fig_4_GBM_immuno.pdf",
  plot = volcano_plot,
  device = "pdf",
  dpi = 600,
  width = 45 / 25.4, # Convert mm to inches
  height = 70 / 25.4 # Convert mm to inches
)
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_5/final/glycan_bar_graph.pdf", plot = p, dpi = 1200, width = 60, height = 40, units = "mm")
...
draw(ht)
# Export as PNG
png("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_5/final/heatmap_glycan_classes.png", width = 80, height = 70, units = "mm", res = 600)
draw(ht)
dev.off()
...
for (feature in unique_features) {
  ...
  p <- ggplot(wide_df, aes(x = who_grade, y = .data[[feature]])) +
    ...
    theme(text = element_text(family = "Helvetica", size = 6, color = "black"),
          ...
          axis.title.y = element_text(size = 6, family = "Helvetica", color = "black"),
          #plot.title = element_text(size = 6, family = "Helvetica", color = "black", 
          #                          hjust = 0.5, margin = margin(t = 0, r = 0, b = 0, l = 0)),  # Fix margin issue
          plot.title = element_blank(),
          panel.grid = element_blank(),     # Remove grid lines
          axis.line = element_line(color = "black", linewidth = 0.25))  # Add axis lines
  
  # Save the plot
  ggsave(filename = paste0("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_5/final/boxplot_", feature, ".png"), plot = p,
         dpi = 600, height = 35, width = 35, units = "mm")
  print(p)
}
...
write.csv(combined_data_long, "combined_data_long_heatmap_DE_glycans.csv", row.names = FALSE)
...
# Export as PNG
png("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_5/final/heatmap_glycan_DE.png", width = 180, height = 90, units = "mm", res = 600)
draw(heatmap_result, 
...
# Panel e - part 1 - cell - glycan correlation ----
...
saveRDS(significant_data, file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/glycan_cell_significant_data_fig_5.rds")




# Panel e - part 2 - RNA - glycan correlations----
...
saveRDS(glycan_gene_lists, file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/glycan_gene_lists_fig_5.rds")
...
saveRDS(go_results, file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/go_results_fig_5.rds")
...
saveRDS(overlap_matrix, file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/overlap_matrix_fig_5.rds")
...
saveRDS(filtered_overlap_matrix, file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/filtered_overlap_matrix_fig_5.rds")


# Panel e - part 3 - Cell - glycan - RNA correlation illustration ----
...
saveRDS(merged_all_top_go_df, file = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/analysis/feature_tables/merged_all_top_go_df_fig_5.rds")
...
# # Normalize gene_count weights in all_top_go_df
# all_top_go_df <- all_top_go_df %>%
#   mutate(gene_count = normalize(gene_count))
# 
# # Merge the filtered data with descriptions and normalized gene counts
# plot_data <- filtered_data %>%
#   inner_join(all_top_go_df %>% select(glycan = glycan, Description, gene_count), 
#              by = c("Glycan" = "glycan"))
...
#       # Rename to Vesicle mediated transport
#       Original_Descriptions %in% c(
#         "vesicle-mediated transport in synapse_fucosylated / synaptic vesicle cycle_fucosylated",
#         "synaptic vesicle recycling_fucosylated / synaptic vesicle endocytosis_fucosylated / presynaptic endocytosis_fucosylated",
#         "regulation of exocytosis_fucosylated",
#         "calcium-ion regulated exocytosis_fucosylated",
#         "vesicle-mediated transport in synapse_agalactosylated / synaptic vesicle cycle_agalactosylated"
#       ) ~ "Vesicle mediated transport",
#       
#       # Rename to Neuronal development and neurotransmitter signaling
#       Original_Descriptions %in% c(
#         "exocytosis_fucosylated / regulated exocytosis_fucosylated / neurotransmitter transport_fucosylated / neurotransmitter secretion_fucosylated / signal release from synapse_fucosylated / regulation of neurotransmitter levels_fucosylated / synaptic vesicle exocytosis_fucosylated / signal release_fucosylated",
#         "modulation of chemical synaptic transmission_agalactosylated / regulation of trans-synaptic signaling_agalactosylated",
#         "synapse organization_agalactosylated",
#         "neurotransmitter transport_agalactosylated / regulation of neurotransmitter levels_agalactosylated / neurotransmitter secretion_agalactosylated / signal release from synapse_agalactosylated / exocytosis_agalactosylated / synaptic vesicle exocytosis_agalactosylated / regulated exocytosis_agalactosylated",
#         "axon development_agalactosylated / axonogenesis_agalactosylated",
#         "regulation of neuron projection development_agalactosylated"
#       ) ~ "Neuronal development and neurotransmitter signaling",
#       
#       # Rename to Regulation of translation
#       Original_Descriptions %in% c(
#         "cytoplasmic translation_sialylated",
#         "regulation of translation_sialylated"
#       ) ~ "Regulation of translation",
#       
#       # Rename to Antigen presentation through MHC class II
#       Original_Descriptions %in% c(
#         "MHC protein complex assembly_sialylated / peptide antigen assembly with MHC protein complex_sialylated / antigen processing and presentation of peptide antigen_sialylated / antigen processing and presentation of exogenous peptide antigen via MHC class II_sialylated / MHC class II protein complex assembly_sialylated / peptide antigen assembly with MHC class II protein complex_sialylated / antigen processing and presentation of peptide antigen via MHC class II_sialylated / antigen processing and presentation of peptide or polysaccharide antigen via MHC class II_sialylated / antigen processing and presentation of exogenous peptide antigen_sialylated / antigen processing and presentation_sialylated / antigen processing and presentation of exogenous antigen_sialylated",
#         "antigen processing and presentation of peptide antigen_triantennary / antigen processing and presentation of exogenous peptide antigen_triantennary / antigen processing and presentation of exogenous antigen_triantennary / antigen processing and presentation of exogenous peptide antigen via MHC class II_triantennary / antigen processing and presentation_triantennary / antigen processing and presentation of peptide antigen via MHC class II_triantennary / antigen processing and presentation of peptide or polysaccharide antigen via MHC class II_triantennary / MHC protein complex assembly_triantennary / peptide antigen assembly with MHC protein complex_triantennary / MHC class II protein complex assembly_triantennary / peptide antigen assembly with MHC class II protein complex_triantennary"
#       ) ~ "Antigen presentation through MHC class II",
#       
#       # Rename to Leukocyte mediated immunity
#       Original_Descriptions == "leukocyte mediated immunity_triantennary / immunoglobulin mediated immune response_triantennary / B cell mediated immunity_triantennary / adaptive immune response based on somatic recombination of immune receptors built from immunoglobulin superfamily domains_triantennary" ~ "Leukocyte mediated immunity",
#       
#       # Rename to Integrin signaling
#       Original_Descriptions == "positive regulation of integrin-mediated signaling pathway_sialylated" ~ "Integrin signaling",
#       
#       # Rename to Response to hormones
#       Original_Descriptions == "response to peptide hormone_sialylated" ~ "Response to hormones",
#       
...
# Custom colors for Glycan nodes
glycan_colors <- c(
  "Sialylated" = "#b81b4a",   # Red
  "Fucosylated" = "#228b22",  # Green
  "Triantennary" = "#1f78b4", # Blue
  "Agalactosylated" = "#d2691e"        # Brown
)
...
png("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_5/final/Feature_Glycan_Description_Connections.png",
    bg = "transparent",
    width = 150,
    height = 125,
    units = "mm",
...
# Normalize weights for Feature -> Glycan edges
feature_to_glycan_edges <- plot_data %>%
  select(from = Feature, to = Glycan, weight = Correlation) %>%
  mutate(
    type = "Feature-to-Glycan"
    #weight = normalize(weight)  # Normalize correlation weights
  )

# Normalize weights for Glycan -> Description edges
glycan_to_description_edges <- plot_data %>%
  select(from = Glycan, to = Description, weight = gene_count) %>%
  mutate(
    type = "Glycan-to-Description"
    #weight = normalize(weight)  # Normalize gene count weights
  )

# Combine both sets of edges into one DataFrame
edges_df <- bind_rows(feature_to_glycan_edges, glycan_to_description_edges)

# Print the normalized edges DataFrame for inspection
print(edges_df)

# Save the DataFrame to a CSV for further inspection if needed
write.csv(edges_df, "edges_debug_data_normalized.csv", row.names = FALSE)

# Optional: View the DataFrame in RStudio Viewer
View(edges_df)


# Panel e - part 4 - RNA - cell correlations----
...
png(
  filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_5/final/heatmap_output_panel_e_mod.png",
  width = 60, height = 155, units = "mm", res = 600
)
draw(ht)
dev.off()
...
feature_size <- "Neutrophils_over_all_cell_count_FOV_immune_prop"  # Replace with desired feature for size
...
feature_size <- "Neurons_over_all_cell_count_FOV_immune_prop"  # Replace with desired feature for size
...
ggplot(filtered_data_wide, aes_string(x = feature_x, y = feature_y, size = feature_size, color = "who_grade")) +
  ...
  scale_color_manual(
    values = c("2" = "#228b22", "3" = "#d2691e", "4" = "#93003a")  # Assign specific colors
  ) +
  labs(
    x = NULL,
    y = NULL,
...
# Create a dynamic file path with feature names included
file_path <- sprintf(
  "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_5/final/scatter_plot_%s_vs_%s_size_%s.png", 
  feature_x, feature_y, feature_size
)
...
auc_df_GBM <- read_csv("../Cohort_analysis/tables/auc_data_who_grade.csv")
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/AUC_who_grade.png", plot = auc_plot, dpi = 1200, width = 35, height = 35, units = "mm")


# Panel c - median feature importance plot (WHO grade) ----

importance_df_filtered <- read_csv("../Cohort_analysis/tables/rf_gini_importance_df_who_grade.csv") %>%
...
#ggsave("../figures/detailed_features.png", plot = plot, width = 110, height = 110, units = "mm", dpi = 1200)
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/detailed_features_who_grade.png", plot = plot, width = 80, height = 42, units = "mm", dpi = 1200)
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/type_features_who_grade.png", plot = plot, width = 40, height = 90, units = "mm", dpi = 1200)
...
# Save the plot as a PNG file
ggsave(
  filename = "/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/annotation_plot_who_grade.png",
  plot = annotation_plot,
  width = 5,       # Width in mm
...
p
# Save the plot as a PNG file
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/CD31_intensity_who_grade_plot.png", plot = p, dpi = 600, height = 43, width = 50, units = "mm")
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/VEGFA_who_grade_plot.png", plot = p, dpi = 600, height = 43, width = 50, units = "mm")
...
auc_df_GBM <- read_csv("../Cohort_analysis/tables/auc_data_survival_status.csv")
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/AUC_survival.png", plot = auc_plot, dpi = 1200, width = 35, height = 35, units = "mm")


# Panel i - median feature importance plot (survival) ----

importance_df_filtered <- read_csv("../Cohort_analysis/tables/rf_gini_importance_df_survival_status.csv") %>%
  arrange(desc(Importance))
...
#ggsave("../figures/detailed_features.png", plot = plot, width = 110, height = 110, units = "mm", dpi = 1200)
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/detailed_features_survival_status.png", plot = plot, width = 80, height = 42, units = "mm", dpi = 1200)


# Panel j - PCA plot of survival ----


PCA <- read_csv("../Cohort_analysis/tables/pca_subset.csv")
...
p <- ggplot(PCA, aes(x = PC1, y = PC2, color = survival_status)) +
  ...
  scale_color_manual(values = c("long" = "#9DCED6", "short" = "#b81b4a")) +
  labs(title = "",
       x = "PC1 (27%)",
       y = "PC2 (9%)")
...
ggsave("/Users/piyadasa/Library/CloudStorage/GoogleDrive-piyadasa@stanford.edu/Shared drives/BRUCE_data/resource_paper_drafts/Figures/Figure_6/final/PCA_scatter_plot.png", plot = p, width = 40, height = 38, units = "mm", dpi = 1200)
